...
import cruxic.jftgl_copy.Vector3f;
...
public class FTBBox
{
	...
	public static ByteBuffer EMPTY_ByteBuffer = ByteBuffer.allocateDirect(0);
	...
	public static boolean renderBBox(Vector3f pos, FTBBox box)
	{
		...
		GL11.glBitmap(0, 0, 0f, 0f, pos.x, pos.y, EMPTY_ByteBuffer);
